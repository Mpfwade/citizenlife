...
function PLUGIN:takePicture()
	if ((self.lastPic or 0) < CurTime()) then
		...
		--Schema:AddCombineDisplayMessage("Prepare to receive visual download...", Color(0, 255, 0, 255))
...
net.Receive("ixovcamdata", function()
...
net.Receive("ixcamClearPicture", function()
...
concommand.Add("ix_camera_photocache", function()
	if LocalPlayer():IsCombine() then
		...
		LocalPlayer():ChatPrint("not cumbine player")
		return false
	end
end)