util.AddNetworkString("ixovcamData")
util.AddNetworkString("ixcamPicture")
util.AddNetworkString("ixcamClearPicture")

net.Receive("ixovcamData", function(length, client)
...
net.Receive("ixcamPicture", function(length, client)
