...
function PANEL:Init()
	...
	leftpanel.Paint = function(self, w, h)
		...
		draw.DrawText("READ THE RULES!", "ixMenuButtonFontSmall", w / 2, h - 128, Color(210,39,48), TEXT_ALIGN_CENTER)
		draw.DrawText("CHECK THE INFORMATION IN THE DISCORD!", "ixSmallFont", w / 2, h - 96, color_white, TEXT_ALIGN_CENTER)
		draw.DrawText("Make sure to send your thoughts in discord too.", "ixSmallFont", w / 2, h - 80, color_white, TEXT_ALIGN_CENTER)
		draw.DrawText("https://tinyurl.com/citizenlife", "AdminChatFont", w / 2, h - 64, Color(0, 100, 200), TEXT_ALIGN_CENTER)

		ix.gui.GlowingLogo(20, 20, w - 40, w / 3 - 40, true)
	end

	-- button list
	self.mainButtonList = leftpanel:Add("ixCharMenuButtonList")
	self.mainButtonList:Dock(TOP)
	self.mainButtonList:DockMargin(20, 170, 20, 0)

	-- create character button
	local createButton = self.mainButtonList:Add("ixMenuButton")
	createButton:SetFont("LiteNetworkFont32")
	...
	self.loadButton:SetFont("LiteNetworkFont32")
	...
	if (extraURL != "" and extraText != "") then
		...
		extraButton:SetFont("LiteNetworkFont32")
	...
	self.returnButton:SetFont("LiteNetworkFont32")
