...
function ENT:Draw( )
    ...
    cam.Start3D2D( self:GetPos( ) + self:GetForward( ) * 13 + self:GetRight( ) * 8.5 + self:GetUp( ) * 20, angle, 0.0364 )
        ...
        draw.SimpleText( "PLEA TERMINAL", "terminal_title", 248, 20, Color( 255, 255, 225, 50 + math.abs( math.sin( CurTime( ) ) ) * 300 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
        ...
        if ( self:GetNetVar( "alarm" ) ) then
            ...
            draw.SimpleText( "INSERT CITIZEN ID TO", "terminal_infoText", 248, 375, Color( 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
            draw.SimpleText( "REQUEST CIVIL PROTECTION", "terminal_infoText", 248, 405, Color( 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
        end
