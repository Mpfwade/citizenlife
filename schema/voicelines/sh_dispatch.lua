...
Schema.voices.Add("Dispatch", "ACCESS NOT PERMITTED", "Attention please. Access is not permitted. Anti-citizen scavenging will result in immediate capital prosecution.", "dispatch/disp_restrictedblock3.wav", true)
Schema.voices.Add("Dispatch", "ACCESS TO BLOCK", "Attention please. Access to this block is not permitted. To receive this message is to be in civil code violation.", "dispatch/disp_restrictedblock1.wav", true)
Schema.voices.Add("Dispatch", "ACCESS TO BLOCK SECURITY", "	Attention please. Access to this block is not permitted. Local security deployed and designated to prosecute.", "dispatch/disp_restrictedblock2.wav", true)
Schema.voices.Add("Dispatch", "ADMINISTRATION IN PROGRESS", "Security alert. Re-administration in progress. Asset allocation adjustment code: Flint. Inspect. Extirpate. Priority: immediate.", "dispatch/disp_assetallocation.wav", true)
Schema.voices.Add("Dispatch", "CHARGED MULTIPLE", "Individual, you are now charged with multiple level five anti-civil activity violations. Please cooperate with ground protection team. Ground protection team: alert. Code: Engage. Isolate. Neutralize.", "dispatch/disp_anticivil.wav", true)
Schema.voices.Add("Dispatch", "CIVILIZED SOCIETY", "Citizen Reminder: a civilized society demands swift and targeted oversight. Prohibit fellow citizens from threatening the community.", "dispatch/disp_civilized.wav", true)
Schema.voices.Add("Dispatch", "CRITICAL BREACH", "Critical breach. Stand by. Stand by.", "dispatch/disp_criticalbreach.wav", true)
Schema.voices.Add("Dispatch", "CRITICAL CIVIL", "Security alert. Critical civil insurrection. Deploy technician teams to Blocks 49, 64, 77. Maintain priority.", "dispatch/disp_civilinsurrection.wav", true)
Schema.voices.Add("Dispatch", "EMERGENCY CODE VOID", "Alert ground units. Alert command units. Emergency code: void.", "dispatch/disp_emergencycodevoid.wav", true)
Schema.voices.Add("Dispatch", "INCIDENT RESPONSE", "Ground Protection Team: alert. Incident response deployment required. Nine-two-one-two.", "dispatch/disp_incidentresponse.wav", true)
Schema.voices.Add("Dispatch", "INVASIVE OPERATION", "Alert. Ground units. Invasive operation of anti-citizen origin. Response code: Engage. Quell. Inquire.", "dispatch/disp_anticitizen.wav", true)
Schema.voices.Add("Dispatch", "MISSION FAILURE", "Security alert. Reminder, ground teams: Mission failure will result in permanent relocation. Response code: Breach. Maneuver. Inoculate.", "dispatch/disp_permanentrelocation.wav", true)
Schema.voices.Add("Dispatch", "OPERATION ENGAGEMENT", "Full system alert. Operation engagement five-one-two-nine. Immediate, concurrent deployment. Five-one-two-nine.", "dispatch/disp_emergencycodevoid.wav", true)
Schema.voices.Add("Dispatch", "OVERLOAD PROTOCOL", "Alert. Response team. Overload protocol: Angle. Cauterize. Flash. Angle. Cauterize. Flash.", "dispatch/disp_overloadprotocol.wav", true)
Schema.voices.Add("Dispatch", "RE ADMINISTRATION", "Security alert. Re-administration in progress. Asset allocation adjustment code: Flint. Inspect. Extirpate. Priority: immediate.", "dispatch/disp_sterilization.wav", true)
