...
function PANEL:Init()
	...
	self.divisionBox.OnSelect = function(panel, index, value)
		...
		if self.rankBox and self.rankBox:GetValue():find("ORDINAL") then
	    ...
	    if self.rankBox and self.rankBox:GetValue():find("EOW") then
			self.modelPreview:SetModel(ix.divisions.ota[self.selectedDivisionID].model_eow or LocalPlayer():GetModel(), ix.divisions.ota[self.selectedDivisionID].skin_eow or LocalPlayer():GetSkin())
		else
			self.modelPreview:SetModel(ix.divisions.ota[self.selectedDivisionID].model, ix.divisions.ota[self.selectedDivisionID].skin)
		end
	end
