...
function SWEP:ViewModelDrawn()
    ...
    if not IsValid(self.AttachedCosmetic) then
        if ( attData.Cosmetic.Model ) then
            self.AttachedCosmetic = ClientsideModel(attData.Cosmetic.Model, RENDERGROUP_VIEWMODEL_TRANSLUCENT)
        end
        ...
        if ( attData.Cosmetic.Material ) then
            self.AttachedCosmetic:SetMaterial(attData.Cosmetic.Material)
        end

        if ( attData.Cosmetic.Color ) then
            self.AttachedCosmetic:SetColor(attData.Cosmetic.Color)
        end

        if ( attData.Cosmetic.Skin ) then
            self.AttachedCosmetic:SetSkin(attData.Cosmetic.Skin)
        end
    else
...
function SWEP:DrawWorldModel()
    ...
    if not IsValid(self.worldAttachment) then
        if ( attData.Cosmetic.Model ) then
            self.worldAttachment = ClientsideModel(attData.Cosmetic.Model, RENDERGROUP_VIEWMODEL_TRANSLUCENT)
        end
        self.worldAttachment:SetParent(vm)
        ...
        if ( attData.Cosmetic.Material ) then
            self.worldAttachment:SetMaterial(attData.Cosmetic.Material)
        end

        if ( attData.Cosmetic.Color ) then
            self.worldAttachment:SetColor(attData.Cosmetic.Color)
        end

        if ( attData.Cosmetic.Skin ) then
            self.worldAttachment:SetSkin(attData.Cosmetic.Skin)
        end
    else
        self.worldAttachment:Remove()
        if ( attData.Cosmetic.Model ) then
            self.worldAttachment = ClientsideModel(attData.Cosmetic.Model, RENDERGROUP_VIEWMODEL_TRANSLUCENT)
        end
        self.worldAttachment:SetParent(vm)
