...
ix.combineterminal.charges = {
	...
	{name = "95, illegal carrying (weaponry)", severity = 20, sound = "npc/overwatch/radiovoice/illegalcarrying95.wav"},
	...
	{name = "243, assault on protection team", severity = 20, sound = "npc/overwatch/radiovoice/assault243.wav"},
	{name = "404, riot", severity = 20, sound = "npc/overwatch/radiovoice/riot404.wav"},
	{name = "405, conspiracy", severity = 20, sound = ""},
