if CLIENT then
    ...
    concommand.Add("fontcheck", function()
        ...
        if(FONTCHECK) then
            ...
            AddLabelPanel("LiteNetworkFont28")
            AddLabelPanel("BroadcastFont")
            AddLabelPanel("AdminChatFont")
            AddLabelPanel("RadioFont")
            AddLabelPanel("DefaultFixed")
            AddLabelPanel("Default")
            AddLabelPanel("GModNotify")
            AddLabelPanel("ChatFont")
            AddLabelPanel("HudDefault")
            AddLabelPanel("TargetID")
            AddLabelPanel("TargetIDSmall")
            AddLabelPanel("Trebuchet18")
            AddLabelPanel("Trebuchet24")
            AddLabelPanel("TabLarge")
